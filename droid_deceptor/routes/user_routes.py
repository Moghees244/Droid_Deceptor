...
from droid_deceptor.controllers.user_controllers.attack_generator import generate_attack, download_file
...
user_routes.route('/download/<filename>', methods=['GET'])(download_file)
